...
To link our data to our curiosity of playcalling strategy, we focused on 4 methods: Logistic Regression, Generalized Additive Modeling, Multimonial Modeling, and Multilevel Modeling. 
...
```{r}
pander(exp(coef(summary(model4))))
```
The multilevel model generally follows that of logistic regression in that the 3rd previous play had the highest effect and the 2nd previous play had the lowest. 
