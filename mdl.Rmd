...
```{r}
model4 <- glmer(outcome ~ as.factor(prev_play_1) + as.factor(prev_play_2) + as.factor(prev_play_3) + (1|posteam) + (1|defteam) + (1|posteam:defteam) + ydstogo + pass_rank, data = df, family = "binomial")
summary(model4)
```
